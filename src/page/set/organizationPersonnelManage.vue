...
<script>
  ...
  import {getOrganizationalManagementTree,getOrgUserList,addOrgUser} from '../../service/peopleApi';
  export default {
      data(){
          return {
            dataList:[],
...
//      },
    ...
    mounted (){
      // 异步获取数据操作
      let _this = this;
      getOrganizationalManagementTree(this.$store.state.generalGroupId).then(function (res) {
