            ...
            template:
	            `<li :class="liClassVal">
					...
					<a  @mouseenter='enterFunc(model)' @mouseleave='leaveFunc(model)'  @contextmenu.prevent='cxtmenufunc(model)'>
					    ...
					    <span  v-show='model.hover && model.orgLevel != 1' title='授权组织' class="button authorize"></span>
					    <span  v-show='model.hover && model.orgLevel != 1' title='删除组织' class="button dels"></span>
					</a>
